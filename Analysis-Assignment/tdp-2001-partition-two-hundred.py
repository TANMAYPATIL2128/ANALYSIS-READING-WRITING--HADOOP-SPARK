...
#reading 2001 file
df1 = spark.read.text("hdfs://namenode/output/itmd-521/tdp/2001/csv-file")
#creating dataframe
...
#writing csv file by lz4 compression repartition by 200 
df2.repartition(200).write.format("csv").option("compression","lz4").option("header","true").save("hdfs://namenode/output/itmd-521/tdp/2001/repartition/200")
...
#writng the file
newdf.write.partitionBy('month').format("parquet").mode("overwrite").option("header","true").save("hdfs://namenode/output/itmd-521/tdp/2001/Partition-By-Month-Parquet")

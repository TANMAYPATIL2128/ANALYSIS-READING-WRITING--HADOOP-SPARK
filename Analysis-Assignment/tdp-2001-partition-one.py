...
#writing csv file by lz4 compression repartition by 1
df2.repartition(1).write.format("csv").option("compression","lz4").option("header","true").save("hdfs://namenode/output/itmd-521/tdp/2001/repartition/1")
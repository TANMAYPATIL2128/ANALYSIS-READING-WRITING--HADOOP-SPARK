...
#query related to selection of air temperature by range from year 2000-2010
...
#writing the file
df1.write.csv(path="hdfs://namenode/output/itmd-521/tdp/20/valid-records-temperature/Min_Max", mode="overwrite",header="true")
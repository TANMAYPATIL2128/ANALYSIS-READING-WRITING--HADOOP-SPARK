...
#query to select he year from observation date
df5_20 = spark.sql("SELECT * FROM MainTable WHERE year(Observation_Date) between 2000 and 2005")
#writing a csv file by repartition 200
df5_20.repartition(200).write.format("csv").option("compression","lz4").mode("overwrite").option("header","true").save("hdfs://namenode/output/itmd-521/tdp/2000-2005/repartition/200")
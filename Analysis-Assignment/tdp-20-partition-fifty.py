...
#writing a csv file by  repartition 50
df5_20.repartition(50).write.format("csv").option("compression","lz4").mode("overwrite").option("header","true").save("hdfs://namenode/output/itmd-521/tdp/2000-2005/repartition/50")